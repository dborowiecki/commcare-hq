...
class DeliveryGroups(object):
    ...
    def delivering(self, facs=None, month=None):
        ...
        if not facs:
            return []
        return filter(lambda f: self.current_delivering_group(month) in f.metadata.get('group', []), facs)
    ...
    def processing(self, facs=None, month=None):
        ...
        if not facs:
            return []
        return filter(lambda f: self.current_processing_group(month) in f.metadata.get('group', []), facs)
    ...
    def submitting(self, facs=None, month=None):
        ...
        if not facs:
            return []
        return filter(lambda f: self.current_submitting_group(month) in f.metadata.get('group', []), facs)

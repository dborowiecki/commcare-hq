...
#TODO: Ma rozpoznawać albo w handlerze ogolnym albo polaczyc z tanzania/handler i dodac jakiegos ifa
class RegistrationHandler(KeywordHandler):
    ...
    def handle(self):
        ...
        #TODO: to pewnie można do funkcji zewnętrznej wyrzucić bo od tego momentu jest to samo co w tanzanii
        if not self.user:
            ...
            for domain in domains:
                ...
                #TODO: Oprócz tego ale to da rade ogarnąć
                if len(words) == 3:
                    user.user_data = {
                        'role': words[2]
                    }

...
from corehq.apps.userreports.reports.view import CustomConfigurableReport, ConfigurableReportView
...
class MultiSheetReportExport(ReportExport):
    ...
    def get_table(self):
        ...
        x = [
            [
                'Nazwa1',
                [[str([x.header for x in p.columns]), 'rowe232'],
                 ['owe', 'bowe']]
            ],
            [
                'Nazwa2',
...
class ProcessDataReport(CustomConfigurableReport):
    ...
    def report_export(self):
        print("\n\n--------------\nNO ELO MORDZIATY\n---------\n\n")
        return MultiSheetReportExport(self.domain, "21XD23XDDDDDDDDDDDd", self.spec, self.lang, self.filter_values)

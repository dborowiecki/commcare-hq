...
REGISTER_HELP = _("Sorry, I didn't understand. To register, send register <name> <facility code>. Example: register john dwdh'")
REGISTRATION_CONFIRM = _("Congratulations %(contact_name)s, you have successfully been registered for the Early Warning System. Your facility is %(sdp_name)s")
REGISTER_MESSAGE = _("You must be registered on EWS before you can submit a stock report. Please contact your DHIO or RHIO.")

...
class ApisTest(TestCase):
    ...
    def test_parse_stocktransaction_json(self):
        ...
        self.assertEqual("2013-08-30T14:19:36.269120", stock_transaction.date)
        self.assertEqual(Decimal(0), stock_transaction.ending_balance)
        self.assertEqual("mg", stock_transaction.product)
        self.assertEqual(Decimal(0), stock_transaction.quantity)
        self.assertEqual(654, stock_transaction.supply_point)
        self.assertEqual("Stock Received", stock_transaction.report_type)

...
class StockOnHandTest(EWSScriptTest):
    ...
    def test_stockout(self):
        a = """
           ...
           5551234 < Dear stella, these items are stocked out: lf mc. Please order lf 30, mc 14.
           """
        self.run_script(a)
    ...
    def test_low_supply(self):
        a = """
           ...
           5551234 < Dear stella, these items need to be reordered: lf mc. Please order lf 34, mc 39.
           """
        self.run_script(a)
    ...
    def test_combined1(self):
        a = """
           ...
           5551234 < Dear stella, these items are stocked out: lf. these items need to be reordered: mc. Please order lf 30, mc 50.
           """
        self.run_script(a)
    ...
    def test_combined2(self):
        a = """
           ...
           5551234 < Dear stella, these items are stocked out: mc. these items need to be reordered: mg. Please order mc 14, mg 14.
    ...
    def test_combined3(self):
        a = """
           ...
           222222 < Dear super, Test RMS is experiencing the following problems: stockouts Male Condom; below reorder level Micro-G
           5551234 <  Dear stella, these items are stocked out: mc. these items need to be reordered: mg. Please order mc 14, mg 14.
           5551234 > soh mc 2.0 mg 1.0 ng 300.0
           222222 < Dear super, Test RMS is experiencing the following problems: below reorder level Male Condom Micro-G
           5551234 <  Dear stella, these items need to be reordered: mc mg. Please order mc 14, mg 14.
           """
        self.run_script(a)
